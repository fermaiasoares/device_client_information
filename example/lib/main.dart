...
class _MyHomePageState extends State<MyHomePage> {
  DeviceClientInformation? basicInfo, decoratedInfo;
  ...
  void _fetchInfo() async {
    basicInfo = await DeviceClientInformation.getInformation();

    decoratedInfo = await DeviceClientInformation.getInformation(
      decorators: DeviceInformationDecorators(
    ...
    // decoratedInfo = (await DeviceInformation.fetch()).decoration(
    //     deviceId: (oriInfo, value) =>
    //         'prefix-$value-${oriInfo.applicationName}');
    setState(() {
      basicInfo = basicInfo ?? decoratedInfo;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Device Client Information Example'),
      ),
