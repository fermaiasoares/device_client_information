...
class DeviceInformationPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "device_information")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "device_information")
      channel.setMethodCallHandler(DeviceInformationPlugin())
    }
  }
