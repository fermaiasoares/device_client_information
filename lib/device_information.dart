...
part 'device_information_decorator.dart';

class DeviceInformation {
  static const MethodChannel _channel = MethodChannel('device_information');

  /// A flag to identify testing mode
  static bool _isMockMode = false;

  /// Mock data for test
  static late final DeviceInformation _mockData;
  ...
  factory DeviceInformation._fromMap(Map<String, dynamic>? map) {
    if (map == null) return DeviceInformation();
